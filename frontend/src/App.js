      ...
      <CartProvider>
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute><ErpLayout /></ProtectedRoute>}>
            ...
            <Route path="/app/sucursales" element={<RequirePerm perm="config"><EnConstruccion titulo="Sucursales" /></RequirePerm>} />
            <Route path="/app/impresoras" element={<RequirePerm perm="config"><EnConstruccion titulo="Impresoras" /></RequirePerm>} />
            <Route path="/app/cuentas-bancarias" element={<RequirePerm perm="cuentas.ver"><EnConstruccion titulo="Cuentas bancarias" /></RequirePerm>} />
